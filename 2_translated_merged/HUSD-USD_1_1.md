...
Huobi had an event where HUSD transactions were fee-free for a while. I created a script to take advantage of this.
The strategy leverages the tendency of prices to return to 1 for stable arbitrage.
...
|FEE_RATE|false|(?profit rate) transaction fee|
