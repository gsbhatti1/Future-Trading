...
This strategy makes full use of multiple indicators from the Ichimoku Balance Sheet to confirm the trend and uses the cloud layer as a dynamic stop loss level to effectively control risks.

## Strategic Advantages

- The Ichimoku Balance Sheet combines multiple factors to determine trends.
- Dynamic stop loss to lock in profits to the greatest extent.
- Simple, clear, and easy-to-implement rules.

## Strategy Risk

- The Ichimoku balance meter is slow and may miss opportunities.
- Careful optimization of parameter periods is required.
...
2. Consider long when close is above cloud and cloud is rising, with conversion above baseline.
...
This strategy leverages Ichimoku's synthesis of indicators to define trend direction. With optimized parameters, it provides a simple long-only system. However, limitations in lag and being LONG-only require caution.
