...
This strategy is based on the AlphaTrend indicator. When the price crosses above the AlphaTrend line, a long position is taken. When the price crosses below the AlphaTrend line, a short position is taken.
