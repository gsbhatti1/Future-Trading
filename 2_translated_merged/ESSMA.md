...
The concept here is to generate a combination moving average, each MA type can be weighted to provide a higher degree of trend confirmation.
...
The indicator provides a good resistance support value in the larger time frame. And also provides breakout and breakdown indication. Follow through is mostly effective.
