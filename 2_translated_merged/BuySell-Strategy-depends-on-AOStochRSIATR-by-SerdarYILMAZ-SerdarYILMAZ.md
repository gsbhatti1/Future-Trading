...
// Bu strateji sadece pine script'te kodlamanın nasıl yapıldığını öğrenmek için kullanılır.
// Bu stratejiye dayanarak kesinlikle al-sat işlemleri yapmayınız.
...
plot(awesome, style=plot.style_histogram, color=color.new(color.green, 0) when awesome > awesome[1] else color.red)
