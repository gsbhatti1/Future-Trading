...
Delta Dynamic Hedge Strategy for Deribit Options Teaching

> Author

InnovQuant - Xiao Xiaomeng

> Strategy Description

## Deribit Options Delta Dynamic Hedge Strategy (Teaching)
...
|hedgeDeltaStep|true|Delta hedge step size|
...
|setHedgeDeltaStep|true|Set hedge threshold|
...
function createManager(e, subscribeList, msg) {
	var self = {}
    self.supportList = ["Futures_Binance", "Huobi", "Futures_Deribit"]  // Supported exchange list
    ...
    self.tickers = []                    // All market data received from interfaces, defined as: {bid1: 123, ask1: 123, symbol: "xxx"}}
    self.subscribeTickers = []           // Required market data, defined as: {bid1: 123, ask1: 123, symbol: "xxx"}}
    self.accData = null 
    self.pos = null 
    ...
    self.setBase = function(base) {
        // Switch base URL for test network
        self.e.SetBase(base)
        Log(self.name, self.label, "Switch to Test Network:", base)
    }

    // Judge data precision
    ...
    self.returnPosTbl = function() {
        ...
        /* Interface return position data format
        {
