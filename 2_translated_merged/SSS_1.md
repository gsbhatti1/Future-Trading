...
For best use of the strategy, use (Take Profit = 1, Use Stop Percentage=false) to get every trade and take profit manually whenever you see the best.

For any notes on the strategy to be edited or for another strategies ideas please comment.

**backtest**

![](https://www.fmz.com/upload/asset/f14d7393482822707c.png)
