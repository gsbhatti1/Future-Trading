...
I received an email about a Trend Following System that sells for $1000, but I could get it that day for only $500!!!

I watched the video demonstrating this "Amazing System," which might have taken me just a minute to reverse-engineer the code.

I coded it up. And hey—it's actually not a bad system. It's useful for people who need an entry signal to get into a trending move and stay in that trend while having a defined stop.

So I thought I'd save the community from paying even the very fair price of only $500 for a system consisting of just a couple of EMAs and a few rules...and give it away for free.

See link below for main chart showing the second system!!!
