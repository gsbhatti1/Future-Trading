...
**How to Use:**
The step-like line is the main trend filter. It is colored green in an uptrend and red in a downtrend. When the smoothing is on, in addition to the trend filter, the indicator plots a purple line. This line is a Hull Moving Average (HMA) of the price. In this case, the indicator uses this line instead of the price to find crossings with the trend filter.
When the price or the smoothed line crosses the trend filter above, it is an uptrend signal. The indicator marks such crossings with green circles and colors the chart background green in an uptrend. When the price or the purple line crosses the trend filter below, it means a downtrend signal. Downtrend signals show as red circles, and the chart background in a downtrend turns red.
...
- Use Smoothing – turns on and off smoothing of the price with HMA. With the smoothing turned on, the indicator responds slower to price changes but produces fewer false signals.

**Backtest:**
![](https://www.fmz.com/upload/asset/174e3fb47f122e56769.png)
...
**Last Modified:** 2022-05-20 16:59:54