...
This strategy is dynamically balanced with 50% of funds and 50% of positions, and risk control is achieved by constantly adjusting the proportion of positions and funds. This is suitable for investors who are unable to monitor the market in real time.
...
// Adding logic: Remaining funds > Unr
```