```plaintext
Name: BuySell-Strategy-depends-on-AOStochRSIATR-by-SerdarYILMAZ
Author: Zer3192
...
// Bu strateji sadece pine script'te kodlamanın nasıl yapıldığını öğrenmek içindır.
// Bu stratejiye dayanarak kesinlikle al-sat işlemlerini yapmayınız.
...
Detail: https://www.fmz.com/strategy/380330

Last Modified: 2022-08-28 05:34:36
```