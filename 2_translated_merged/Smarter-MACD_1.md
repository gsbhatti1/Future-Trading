...
A classic MACD with average peak and dip lines. The lighter green and red horizontal lines are the average peak and dip of the entire span, respectively. The second, bolder line is the average of the peaks and dips above and below the overall peak and dip averages. The filled-in color helps visualize these averages and possible trade setups. Rework of the MACD + Averages script.
...
This is the translated version of your trading strategy document. If there are any additional parts or sections you need to include, please let me know!