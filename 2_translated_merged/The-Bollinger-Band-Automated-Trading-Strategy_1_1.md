...
This strategy combines a short-term and long-term simple moving average (SMA) with Bollinger Bands to identify trading opportunities. When the price closes below the lower band, a long position is initiated.

The initial trade size is fixed, but subsequent safety orders increase in size according to a user-defined percentage. Both profit-taking and stop-loss levels trail the average entry price, set by target percentages.
...
- Scales position sizes using safety orders  
- Compatible with 3Commas trading bots  

**Risks**

Potential risks to consider:

- Late breakout signals during periods of expanding volatility  
- Increased exposure due to pyramided positions  
- Stop-loss orders may lag in fast-moving markets  

This strategy aims to capitalize on trend continuation patterns. Proper stop-loss placement and risk management practices are essential to mitigate potential losses.
