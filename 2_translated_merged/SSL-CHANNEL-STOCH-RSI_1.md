...
//@version=5
indicator("SSL-CHANNEL-STOCH-RSI", shorttitle="SSL", overlay=true, timeframe="", timeframe_gaps=false)
...
This script implements the SSL (Stochastic StochRSI) channel strategy with customizable moving averages and labels.