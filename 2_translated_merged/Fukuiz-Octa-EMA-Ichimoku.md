...
buyCondition = all(ema1 > cloudColor, ema2 > cloudColor, ema3 > cloudColor, ema4 > cloudColor, ema5 > cloudColor, ema6 > cloudColor, ema7 > cloudColor, ema8 > cloudColor)
sellCondition = all(ema1 < color.new(#dfecfb, 30), ema2 < color.new(#dfecfb, 30), ema3 < color.new(#dfecfb, 30), ema4 < color.new(#dfecfb, 30), ema5 < color.new(#dfecfb, 30), ema6 < color.new(#dfecfb, 30), ema7 < color.new(#dfecfb, 30), ema8 < color.new(#dfecfb, 30))
...
In the code above:
- The `EMA` functions and plotting logic are preserved.
- The `Ichimoku` components including lines, clouds, and color settings are maintained.
- The buy/sell conditions based on EMA being above/below the cloud have been added to the Pine Script.