...
The Stochastic is the yellow line.

You can manage the timeframe in the parameters.

The strategy is to take a position when the two lines get overbought or oversold and close when the Stoch and RSI goes to the middle.
