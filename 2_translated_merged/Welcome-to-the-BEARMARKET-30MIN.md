...
This is my first concept of bear market movement bot for the near future.
The bot is optimized for --->>> BINANCE:BTCUSDT.

The core of this bot uses ATR trend to define trends, and also utilizes RSI value to open new swing shorts (RSI-VWAP) or find a perfect close place (RSI oversold).

This bot is solely a short bot designed to maximize profit from every downward movement in Bitcoin.
I recommend using 1-3x leverage for this bot because of the high number of wrong trades or minimal profits.
The stop loss is around: 6% (Just for best performance in all backtesting time periods).

So, the short condition is opened by:

1) Both ADX and S_ATR only if RSI is not oversold
a) ADX is one of the most powerful and accurate trend indicators. It measures how strong a trend is and can provide valuable information on whether there is a potential trading opportunity.
b) The average true range (ATR) is a technical analysis indicator, introduced by market technician J. Welles Wilder Jr. in his book New Concepts in Technical Trading Systems, that measures market volatility by decomposing the entire price range for an asset over a specified period.
...
rsi vwwap opens new positions only if there is no bullish signal from Cloud, ADX, ATR indicators

**backtest**

![](https://www.fmz.com/upload/asset/10b6726f9fa1eb5447c.jpg) 
...
|v_input_12|100|Quantity percent|
|v_input_5|0|ADX_options OPTION: CLASSIC or MASANAKAMURA|
|v_input_6|17|ADX_options LENGTH|
|v_input_7|14|ADX_options THRESHOLD|
|v_input_8|51|RSI length|
