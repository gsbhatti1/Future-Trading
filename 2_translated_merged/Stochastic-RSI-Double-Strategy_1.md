Translate the given trading strategy document from Chinese to English. Keep all code blocks, numbers, and formatting exactly as-is. Only translate the human-readable text.
...
This simple strategy only triggers when both the RSI and the Stochastic are together in an overbought or oversold condition. The one hour chart of the S&P 500 worked quite well recently with this double strategy.
...
![](https://www.fmz.com/upload/asset/7d33b6438e380b1a22.png)
