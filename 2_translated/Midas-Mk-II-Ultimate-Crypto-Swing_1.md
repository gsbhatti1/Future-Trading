...
>> This script is only meant to be used in a 4-hour crypto chart. <<

How It Works - To swing trade in a 4-hour candles, which have a much larger range than shorter timeframe candles, the script utilizes longer-term EMA, SMA, and MACD to account for such conditions. When the EMA and SMA cross, and the rate of change of the MACD histogram is favorable to the direction, then the system provides a long/short signal.
