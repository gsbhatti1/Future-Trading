```javascript
NPeriod=2 // Period
f1=0.47   // Upper and lower range coefficient for the middle band
f2=0.07   // Middle band coefficient
f3=0.25   // Upper and lower band coefficient

//==========================================
// API: Chart 函数使用的简单例子（画图功能）
var chart = { // 在 JS 语言中，这个 chart 是一个对象。在使用 Chart 函数之前我们需要声明一个配置图表的对象变量chart。
