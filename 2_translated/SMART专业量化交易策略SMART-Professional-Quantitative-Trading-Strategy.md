...
- Smart fund selling condition: When the OBV slope is negative, it indicates that institutional fund allocation may occur.
...
When the smart fund buying condition is recognized, go long; when the smart funds selling condition is recognized, go short.
...
When long, if smart money sell signal occurs, close the long position. When short, if smart money buy signal occurs, close the short position.
