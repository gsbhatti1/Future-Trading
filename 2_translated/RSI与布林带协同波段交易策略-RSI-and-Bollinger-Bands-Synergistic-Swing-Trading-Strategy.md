...
//@version=5
strategy("RSI and Bollinger Bands Synergistic Swing Trading Strategy - GPT Demo", overlay=true, commission_type=strategy.commission.percent, commission_value=0.1, slippage=3)
