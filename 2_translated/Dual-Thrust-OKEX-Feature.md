...
function onTick(exchange) {
    ...
    if (LastBarTime !== Bar.Time) {
        ...
        BottomTrack = _N(Bar.Open - (Kx * Range));
        if (LastBarTime > 0) {
        ...
        ChartCfg.yAxis.plotLines[1].value = BottomTrack;
        ChartCfg.subtitle = {
            text: 'Up Track: ' + UpTrack + '  Down Track: ' + BottomTrack
        };
    ...
    LogStatus("Price:", Bar.Close, "Up:", UpTrack, "Down:", BottomTrack, "Wins: ", Counter.w, "Losses:", Counter.l, "Date:", new Date());
    var msg;
