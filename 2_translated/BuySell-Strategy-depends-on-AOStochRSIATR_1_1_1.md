...
Turkish/Turkce
Bu strateji sadece pine script'te kodlamanın nasıl yapıldığını öğrenmek için kullanılmaktadır. Bu stratejiye dayanarak, kesinlikle al-sat işlemi yapmayın.
...
RSI ve Stoch asırı satım bölgesinde iken awesome pozitife dönüyorsa long pozisyon açılır, zarar kes ve kazanç al seviyeleri ATR indikatoru ile tanımlandı.

RSI ve Stoch asırı alım bölgesinde iken awesome negatife dönüyorsa short pozisyon açılır, zarar kes ve kazanç al seviyeleri ATR indikatoru ile tanımlandı.
...
// This strategy is just for training, its purpose is just learning code in pine script.
// Don't make buy or sell decision with this strategy.
// Bu strateji sadece pine script'te kodlamanın nasıl yapıldığını öğrenmek için kullanılmaktadır.
// Bu stratejiye dayanarak, kesinlikle al-sat işlemi yapmayın.
