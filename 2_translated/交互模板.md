...
// Test code
function main() {
$.BindingFunc("test1", function(cmd, param){ // Bind the button with the control name test1, where function(cmd, param) {...} is the response function of the button. The first parameter of the response function is the name of the control that triggers the response function: test1
var ticker = exchange.GetTicker() // The second parameter is the parameter that comes when the control is clicked (numeric type, string type, Boolean type, and drop-down box all have parameters, but buttons do not have parameters)
