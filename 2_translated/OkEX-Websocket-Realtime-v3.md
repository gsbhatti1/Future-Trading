...
Because of the various brain downgrade designs of the new version of `websocket-client`, many functions cannot be used.
You need to install the old version of websocket-client package to use it normally `pip3 install websocket-client==0.46.0`
