...
```pinescript
//@version=2
strategy("30-Minute Swing Trading Strategy", overlay=true, default_qty_type=strategy.cash, default_qty_value=10000, scale=true, initial_capital=10000, currency=currency.USD)
