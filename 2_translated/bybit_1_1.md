...
let pricesChart = Chart([{ // This chart in JavaScript is an object, and before using the Chart function, we need to declare a configuration object variable.
    __isStock: true, // Mark whether it's a general chart. Interested readers can change this to false and run to see the difference.
    tooltip: {
    ...
    xAxis: {
        type: 'datetime'
    }, // X-axis, the current setting is : time.
