...
How It Works - To swing trade in a 4 hr candles, which has a much larger range than shorter timeframe candles, the script utilizes a longer timeframe EMA, SMA, and MACD to account for such. When the EMA and SMA cross and the rate of change of the MACD histogram is favorable in the direction, then the system provides a long/short signal.
How To Use - The script works best when the signal aligns with other analyses (trend, harmonic patterns, etc.). This script does not provide any exit signals; I recommend exiting when the candle breaks out of the structure or using other strategies.

Updates or revisions will be recorded in the comments. Good luck with this script!

**Backtest**
![](https://www.fmz.com/upload/asset/159f8a1509168a68539.jpg) 
