...
// its zero line, going up. Optionally Close price also must stay below the upper BB.
...
// outside Optional Bollinger Squeeze indication.
//
// References:
// -----------
...
//        recognize it as a placeholder alert and other placeholders can be accessed in the alarm
//        message.
//
...
bb_source = input(close, title="Bollinger Source", type=input.source)
