...
Since the account has no assets, detailed testing was not performed. Feedback on bugs is welcome.
QQ: 1051804485
Feedback Address: https://www.botvs.com/bbs-topic/1963
Updated on June 26, 2018, 15:57, fixed a bug.
This universal protocol can be run as an ordinary robot in the BotVs simulator for free. 
In order to use IO functions, you need to override the rpc method in exchange, with a JS example below:
