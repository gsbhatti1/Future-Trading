...
The variable `token` is used to send WeChat push. The following is the application method:
...
Alternatively, you can run it on your own server.
...
However, you need to keep the computer turned on, or you can run it on your own server.
'''
