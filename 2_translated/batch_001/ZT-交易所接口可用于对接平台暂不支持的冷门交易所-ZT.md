...
ZT-Exchange interface can be used to connect to unpopular exchanges that are not currently supported by the docking platform-ZT.
...
"""
'ZT Strategy Ghostwriting' and (Help for this program), write to QQ: 35787501

The ZT exchange interface can be used to connect to the unpopular exchange ZT that is not currently supported by the platform.
"""
