...
The 1-3-1 Red-Green Candlestick Reversal Strategy is a trading strategy that generates buy and sell signals based on candlestick patterns. It seeks buying opportunities when 1 red candlestick is reversed by 3 subsequent green candlesticks.
...
2. Utilizes candlestick pattern features without relying on any indicators, avoiding overoptimization problems.
...
3. No consideration of market trend, significant risk holding during sustained downtrend.
4. Does not account for trading costs and slippage; actual performance may be worse.

Solutions:

1. Consider combining with Moving Averages (MAs) or other indicators to filter signals and improve entry success rate.
...
2. Volume confirmation - only go long if the green candle's volume increases.
...
5. Add more filters - e.g., Moving Averages, volatility, etc., to ensure high-probability entry.
6. Machine learning on big data - collect large amounts of historical data and train optimal parameter thresholds via machine learning.

## Conclusion

The 1-3-1 Red-Green Reversal Strategy is overall a simple and practical short-term trading strategy. It has clear entry and exit rules and good backtest results. With some optimization measures, it can become a reliable quant trading strategy. Risk management is also important to properly manage capital.
...
The 1-3-1 Red-Green Reversal Strategy is overall a simple and practical short-term trading strategy. It has clear entry and exit rules, good backtest results. With some optimization measures, it can become a reliable quant trading strategy. Risk management is also important to manage capital properly.
