...
For my all charts: [https://www.fmz.com/user/6261c777972a854f5c0460520f9206bd](https://www.fmz.com/user/6261c777972a854f5c0460520f9206bd)

You can also see my different details and earnings rates on TraderWagon:
[https://www.traderwagon.com/en/portfolio/3886?ref=zoh4wq9](https://www.traderwagon.com/en/portfolio/3886?ref=zoh4wq9)
...
[https://www.traderwagon.com/en/register?ref=zoh4wq9](https://www.traderwagon.com/en/register?ref=zoh4wq9)
...
TELEGRAM: [https://t.me/tradershaman](https://t.me/tradershaman)

TWITTER: [https://twitter.com/TraderShaman](https://twitter.com/TraderShaman)
...
function main() {
    ...
    // Switch to OKEX V5 Simulation Mode
    ...
    if (isReset) {
        ...
        LogProfitReset()
        LogVacuum()
        Log("Data reset complete", "#FF0000")
    }
    ...
    while (1) {
        ...
        if (pos.length > 1) {
            Log(pos)
            throw "Multiple positions exist simultaneously"
        }
        // Based on the current state
        if (pos.length == 0) { 
            // No position, calculate profit once
            if (!IsVirtual()) {
                var currTotalEq = getTotalEquity()
                if (currTotalEq) {
        ...
        } else if (pos[0].Type == PD_LONG) {   // Long position exists
```