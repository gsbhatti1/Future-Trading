...
The core of the AlphaTrend dual tracking strategy is the AlphaTrend indicator. The AlphaTrend indicator calculates the upper and lower bands based on the adaptive Average True Range (ATR) and price (close price or volume weighted average price). The specific calculation method is:
