...
Integrated Libraries for Take-Profit and Stop-Loss on Three Major Exchanges
...
The fmz platform lacks a take-profit and stop-loss function. When you need to set these functions, you must call other functional interfaces of the exchange. The settings for take-profit and stop-loss vary across different exchanges, so the following packaging has been made.
The take-profit and stop-loss functionality is particularly important as it avoids high handling fees without triggering by market price and also mitigates the risk of liquidation in extreme circumstances.
The function considers both isolated and full positions, as well as U-standard and currency standard situations.
...
# Perform take-profit and stop-loss on the contract with cangType=0, default is isolated position = 1 for full position
