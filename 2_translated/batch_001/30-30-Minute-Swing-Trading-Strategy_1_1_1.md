...
2. Calculate RSI indicator to determine overbought and oversold phenomena

3. When the RSI indicator appears in the oversold area, consider the shock trading opportunities at this point.
...
- There is no certainty in reversal and losses may occur
...
//A Swing trading strategy that uses a combination of indicators, rsi for target, hull for overall direction enad ema for entering the trade using the 30min
