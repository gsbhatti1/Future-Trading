...
The strategy requires constant testing and adjustment, and the parameters are often changed. Stopping and restarting every time is laborious and tedious, and the original profit progress will be lost (although it can also be restored through global parameters). In fact, botvs has provided a way to dynamically adjust parameters-"Strategy Interaction"
