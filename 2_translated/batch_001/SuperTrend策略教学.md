...
// Global variables
var OpenAmount = 0                                                  // Number of positions opened after the opening trade
...
function Trade(Type, Price, Amount, CurrPos, OnePriceTick){    // Handle trading
    if(Type == OPENLONG || Type == OPENSHORT){              // Handle opening trades
    ...
    } else if(Type == COVERLONG || Type == COVERSHORT){     // Handle closing trades
...
This translation maintains the original code structure and formatting while translating all human-readable text into English.