...
This is a trend-following strategy that combines the ADX and RSI indicators. The strategy uses RSI to identify overbought and oversold levels to generate trading signals, and ADX to determine the trend to filter out trades when the trend is unclear, thus avoiding whipsaws in range-bound markets.
...
4. Take profit and stop loss
 ...
 - Swing-based uses recent price swings' highest and lowest points
