...
strategy(title="Andean Oscillator [Strategy]",
         ...
         default_qty_value=100,      // Use 100% of account equity for one trade
...
//------------------------------------------------------------------------------
// Calculation of the Andean Oscillator
//------------------------------------------------------------------------------
...
// Example:
// - If bull > bear, enter a long position (bullish power greater than bearish)
// - If bear > bull, enter a short position (bearish power greater than bullish)

// With pyramiding=0, only one position is opened – if an opposite signal comes,
// The
```