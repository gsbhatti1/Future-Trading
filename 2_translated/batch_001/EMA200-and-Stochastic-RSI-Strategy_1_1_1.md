...
|----|----|----|
|v_input_1|2|(?User-defined Parameters)ATR Multiplier|
|v_input_float_1|1.5|Risk-Reward Ratio|
|v_input_int_1|20|Upper/Lower Shadow Point Ratio(%)|
|v_input_float_2|0.5|Key Candlestick Change(%)|
...
length = 14
smoothing = 'RMA'
m = input(2, 'ATR Multiplier', group = "User-defined Parameters")
src1 = high
src2 = low
pline = true
...
highLowShadowRatio = input.int(defval = 20, title = "Upper/Lower Shadow Point Ratio(%)", minval = 1, maxval = 100, step = 1, group = "User-defined Parameters")
keyCandlestickChange = input.float(defval = 0.5, title = "Key Candlestick Change(%)", minval = 0.1, maxval = 100, step = 0.1, group = "User-defined Parameters")
