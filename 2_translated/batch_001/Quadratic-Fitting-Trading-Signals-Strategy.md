...
This strategy uses quadratic fitting to high and low points of candlesticks, generating trading signals when the actual price breaks through the fitted lines. It attempts to identify key support and resistance levels mathematically for breakout trading.
...
2. Buy signal when the close price breaks above the upper band.
3. Sell signal when the close price breaks below the lower band.
4. N-period verification to avoid false breakouts.
...
3. Multi-period verification avoids false breakouts.
