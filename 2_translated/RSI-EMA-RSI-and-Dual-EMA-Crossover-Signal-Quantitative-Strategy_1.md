...
// RSI and EMA Calculation
rsi_length = v_input_int_1
ema_length_close = v_input_int_2
ema_length_low = v_input_int_3

rsi = rsi(close, rsi_length)
ema_close = ta.ema(close, ema_length_close)
ema_low = ta.ema(low, ema_length_low)

// Buy Signal
buy_signal = (close < ema_close and close < ema_low) and rsi <= v_input_int_4

// Sell Signal
sell_signal = (close > ema_close and close > ema_low) and rsi >= v_input_int_5
