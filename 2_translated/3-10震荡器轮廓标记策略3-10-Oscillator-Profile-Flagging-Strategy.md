...
In addition, the strategy incorporates analysis of the relative strength of buying and selling volume based on the size relationship between buying volume and selling volume of each candlestick. The specific method is: 
- Buying volume = Volume x (Close - Low) ÷ (High - Low)
- Selling volume = Volume x (High - Close) ÷ (High - Low)

If the buying volume is significantly greater than the selling volume, it means the candlestick closes with relatively strong buying power, which is a buy signal.
...
The 3-10 Oscillator Profile Flagging strategy successfully integrates the ideas of MACD analysis, volume comparison, and multi-condition validation to effectively determine the supply and demand relationship and the pending direction in the market. It also includes an internal stop profit and stop loss mechanism to control risks. This strategy has significant optimization potential and broad application prospects, making it worth investors’ serious consideration and in-depth research.