```plaintext
Name: Price Performance Index Strategy (Price-Performance-Index-Strategy)
...
This strategy uses the Price Performance Index (PPI) to determine market trend direction—go long when PPI rises and short when it falls. PPI calculates price change percentage over a period to gauge price momentum and future direction.
