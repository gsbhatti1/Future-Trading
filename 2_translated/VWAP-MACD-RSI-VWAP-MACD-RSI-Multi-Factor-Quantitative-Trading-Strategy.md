...
VWAP-MACD-RSI Multi-Factor Quantitative Trading Strategy - VWAP-MACD-RSI-Multi-Factor-Quantitative-Trading-Strategy
...
// Sell Condition
shortCondition = ta.crossunder(close, vwap) and macdHistogram < 0
```