...
This strategy calculates the highest and lowest prices of recent N bars to set double breakout conditions combined with moving average line to implement a low-buying and high-selling trading strategy.
...
3. Calculate a 200-period simple moving average line `mma` combined with `mma` indicator to determine the trend direction
...
Note: The code block has been adjusted to maintain the original format and content.