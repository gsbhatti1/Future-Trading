...
v_input_1 = input(3, title="Swing Points")
v_input_float_1 = input(1.1, title="Median drop Mult")
v_input_2 = input(-5, title="Floating Loss")
v_input_3 = input(5, title="Number of all orders")
v_input_4 = input(20, title="Length of relative volume")
v_input_5 = input(2, title="Volume Multiplier")
v_input_float_2 = input(true, title="Take Profit Multiplier")
