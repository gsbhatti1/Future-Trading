...
Three EMA Crossover Trend Following Strategy Combined with RSI and Volume Confirmation System-Triple-EMA-Crossover-Trend-Following-Strategy-with-RSI-and-Volume-Confirmation-System
...
// Plot EMA lines and RSI on the chart
plot(emaShort, color=color.blue)
plot(emaLong, color=color.red)
hline(rsiOverbought, "RSI Overbought Level", color=color.orange, linestyle=hline.style_dotted)
