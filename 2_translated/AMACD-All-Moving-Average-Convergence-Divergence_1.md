...
//  Moving Averages. Buy and sell alerts can be set based on moving average crossovers, consecutive convergence/divergence of the moving 
//  averages, and directional changes in the histogram moving averages. 
//
//  The Fast, Slow, and Signal Moving Averages can be set to:
//  Simple Moving Average (SMA)
//  Exponential Moving Average (EMA)
