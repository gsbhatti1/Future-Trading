...
This strategy uses the Average True Range (ATR) indicator to determine trend direction. It goes long when the trend is up and short when the trend is down, making it a trend-following type of strategy.
...
6. Set stop loss to close positions: price breaks below upper band closes longs; price breaks above lower band closes shorts
