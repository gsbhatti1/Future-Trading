...
* Support for OKEX and Binance futures, as well as Binance spot and leverage trading. OKEX spot is not yet supported but can be modified by those interested.
...
* Unifies the order placement logic for both exchanges, which can be viewed in the template source code or examples.
...
When placing high-frequency orders, the exchange may not return order information promptly (on the private channel) but in such cases, market conditions may have already changed. The template maintains a local order status, and strategy implementation is included. It automatically recognizes whether it is OKEX or Binance.
...
The following is a common market maker robot for OKX and Binance based on this template
```
![](https://www.fmz.com/upload/asset/73393d2122c1f41a2a.png)
![](https://www.fmz.com/upload/asset/17efd8896a74dc9e271.gif)
