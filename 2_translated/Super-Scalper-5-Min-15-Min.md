...
This strategy is based on RSI and ATR Bands, which works better in 5 and 15 minutes time frames. Perform enough backtesting with a risk management ratio of at least 1:2R before using it in real-time.

Enter trades only on the screen symbols; use additional buy/sell alerts to book profit or to trail stop-loss (SL).

I have also added a Golden Cross Over of 65 and 21 EMA for trend confirmation.
