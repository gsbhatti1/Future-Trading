...
5. Simple Operation: The strategy logic is clear, easy to understand and execute.
...
4. Parameter Sensitivity: The strategy performance is sensitive to period parameter selection.
