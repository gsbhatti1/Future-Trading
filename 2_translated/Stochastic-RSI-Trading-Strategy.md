...
- Regardless of whether you are long or short, the stop loss is set to 20 ticks
- No matter long or short, the take profit is set to 25 ticks
...
- Longs only if price is below VWAP, shorts only if price is above VWAP
