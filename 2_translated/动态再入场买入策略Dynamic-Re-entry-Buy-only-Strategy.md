...
The strategy also allows for dynamic re-entry, meaning it can open new long positions if the price goes above the three moving averages after an exit. However, the strategy will close the long position if the price closes below the third moving average.
