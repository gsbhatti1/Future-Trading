...
```pinescript
// backtest start: 2019-12-23 08:00:00
// backtest end: 2024-12-09 08:00:00
// backtest period: 1d
// basePeriod: 1d
...
This script uses Pine Script to implement the described SMA-RSI-MACD trading strategy with dynamic limit orders for entry and multiple stop mechanisms for risk management.