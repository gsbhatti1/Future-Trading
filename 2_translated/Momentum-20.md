...
When the oscillator crosses above the base-level, it gives a bullish signal; when below it, it gives a bearish signal. The signals are displayed as green and red labels, respectively.
