...
Integrated Libraries for Take-Profit and Stop-Loss across Three Major Exchanges
...
The fmz platform lacks a take-profit and stop-loss function. When setting these, you need to call other functional interfaces of the exchange. The settings for take-profit and stop-loss vary between exchanges, so the following packaging is provided.
The take-profit and stop-loss functions are particularly important as they avoid high handling fees without triggering by market price, and also prevent liquidation in extreme circumstances.
These functions account for both isolated and full positions, as well as U-standard or currency standard.
