...
The fmz platform does not have a take-profit and stop-loss function. When you need to set a take-profit and stop-loss, you need to call other functional interfaces of the exchange. The take-profit and stop-loss settings for different exchanges are different, so the following packaging is made.
The stop-profit and stop-loss functions are particularly important. They avoid high handling fees without triggering by market price, and also avoid the possibility of being liquidated in extreme circumstances.
