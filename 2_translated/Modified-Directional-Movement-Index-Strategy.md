...
//@version=4
strategy(shorttitle="Modified Directional Movement Index Strategy", title="Modified Directional Movement Index Strategy", overlay=true, default_qty_type=strategy.cash, default_qty_value=10000, initial_capital=10000)
...
// The result is plotted with an oscillator to identify the current trend.
// DMI Modified supports multiple moving averages (default is EMA with length of 9). You can disable moving average smoothing in settings.
...
// RED: Strong Down Trend as DMI Modified is below zero line and DMI modified is descending.
