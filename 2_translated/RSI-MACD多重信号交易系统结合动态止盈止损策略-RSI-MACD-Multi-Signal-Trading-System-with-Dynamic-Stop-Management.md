...
RSI-MACD Multiple Signal Trading System with Dynamic Stop Management-RSI-MACD-Multi-Signal-Trading-System-with-Dynamic-Stop-Management
...
macdFast = input(6, title="MACD Fast Period")
macdSlow = input(13, title="MACD Slow Period")           // Adjusted to increase trade frequency
macdSignal = input(7, title="MACD Signal Period")
...
if (strategy.position_size > 0)  // For long positions
    strategy.exit("Exit Long", from_entry="Buy", stop=close - slPips * syminfo.mintick, limit=close + tpPips * syminfo.mintick)

if (strategy.position_size < 0)  // For short positions
    strategy.exit("Exit Short", from_entry="Sell"
```