...
The Dynamic Momentum Oscillator Trading Strategy is based on the Dynamo indicator proposed by E. Marshall Wall in an article published in July 1996 in the Futures magazine. It normalizes a standard oscillator to eliminate the impact of trends.
