...
// Plotting indicators and strategy signals
plot(smma, title="17-period SMMA", color=color.blue)
plot(longEntryPrice, title="Long Entry Price", style=plot.style_linebr, color=color.green)
plot(shortStopLoss, title="Short Stop Loss", style=plot.style_linebr, color=color.red)
plot(longTakeProfit, title="Long Take Profit", style=plot.style_linebr, color=color.green)
```
||