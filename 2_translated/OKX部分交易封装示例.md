...
class Okex(object):
    ...
    def trade_order(self, symbol, pos_side, trade_side, sz, client_id, ord_type="market", px=None):
        ...
        try:
            ...
            # print(order)
            if len(order['data']) == 0:
                return {"code": 2, "msg": 'OKEX Order API returned error data', "data": {}}
    ...
    def cancel_order(self, data):
        ...
        try:
            ...
            if len(order['data']) == 0:
                return {"code": 3, "msg": 'OKEX Cancel API returned error data', "data": {}}
            if order['code'] == '0':
