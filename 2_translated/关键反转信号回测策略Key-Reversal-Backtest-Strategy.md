...
// Inputs
new_low_bars = input(1, title="Number of bars over which to look for a new low in prices")
take_profit_pips = input(20, title="Take Profit pip")
stop_loss_pips = input(10, title="Stop Loss pip")
