...
The strategy will ride up your stop loss when price movement reaches 1%.

The strategy will close your operation when the market price crosses the stop loss.

The strategy will close operations when the line based on the volatility crosses.

The strategy has the following parameters:

+ **ATR PERIOD** - To select number of bars back to execute calculation
+ **ATR MULTPLIER** - To add a multiplier factor on volatility
+ **INITIAL STOP LOSS** - Where you can insert the value for the first stop.
+ **POSITION TYPE** - Where you can select trade position.
+ **BACKTEST PERIOD** - To select range.

## DISCLAIMER

1. I am not licensed financial advisors or broker dealers. I do not tell you when or what to buy or sell. I developed this software which enables you to execute manual or automated trades multiple trades using TradingView. The software allows you to set the criteria you want for entering and exiting trades.
...
|v_input_13|3|ATR multiplierFactoriplier|
