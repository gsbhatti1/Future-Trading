...
1. Strategy Settings: The strategy defined here is named "Internal Bar Strength Indicator Reversion System", it has an initial capital of $10,000, no overlay, allows up to 5 entries in the same direction, and each trade consists of a quantity of 100 units.
