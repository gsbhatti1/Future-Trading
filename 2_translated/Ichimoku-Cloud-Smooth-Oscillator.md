...
The Ichimoku Cloud is a powerful indicator for tracking trends. By smoothing it and placing it in a separate chart, signals can be easily identified without cluttering the display. The bold line serves as the signal: green indicates a buy signal while red indicates a sell signal. Gray represents a possible change in direction or lack of trend. The thinner line is the width of the cloud which can be used to further determine the direction.
