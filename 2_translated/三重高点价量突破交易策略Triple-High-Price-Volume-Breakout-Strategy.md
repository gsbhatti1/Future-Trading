...
This strategy predicts whether there will be a gap breakout opportunity the next day by judging whether price and trading volume form a triple higher high in the late trading period. It is a typical high-frequency trading strategy.
...
4. During the critical period of late trading, if the above condition is met, it is predicted that a gap breakout may occur the next day.
...
1. Check if the latest 3 bars make triple higher highs in price.
2. Check if the latest 3 bars show increasing volume.
3. Check if the latest 3 bars all closed higher than open.
