...
To ease everyone's trading experience, I made this script which colors RSI overbought and oversold conditions and as a bonus displays bullish or bearish divergences in the last 50 candles (by default, you can change it). The script is open source; part of the code is from Trading View examples. If you have suggestions or if you already made some improvements, please report them in the comments.
