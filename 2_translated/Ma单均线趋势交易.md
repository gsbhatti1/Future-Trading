...
Strategy description: Enter long position when the moving average goes up, enter short position when the moving average goes down. Only enters long positions for Bitcoin.
Trend following strategy

*/

MA_Length = 120 // Number of windows to calculate the value in the channel
trailingPrcnt = 15 // trailing stop loss percentage
