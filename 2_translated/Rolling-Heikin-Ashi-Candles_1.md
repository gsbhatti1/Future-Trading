...
There is no doubt that higher timeframe analysis is a critical study for mastering the markets. I found a need for an indicator that analyzes multiple higher timeframes and provides us with a cumulative or average trend direction. I have already built this indicator, and I will release it soon. The indicator I am building is entirely based on my understanding and perspective of market structure. Please use this indicator idea to remove the repainting issue when you make an indicator that utilizes higher timeframe data.
...
![](https://www.fmz.com/upload/asset/ba7841c71467957b1a.png)
