...
// How to use: test it only on GBPJPY 240 min, wait the end of the candle to place next order, red and blue dots are short and long stop orders, Targets are Upper and Lower Bands. Test it and enjoy but use at your own risk..
// 2016 © F.Peluso
