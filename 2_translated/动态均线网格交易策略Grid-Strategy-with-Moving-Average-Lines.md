...
1. Using MA line to determine trend direction avoids trading against major trends;
2. ATR parameter considers market volatility, making the grid more dynamic;
...
In conclusion, this is an overall mature and simple trend-following grid strategy. It uses moving averages to determine major trends, and establishes a dynamic grid mechanism for batched trades. It has certain risk control capabilities. With further quant optimizations, it can become a very practical quant tool.
