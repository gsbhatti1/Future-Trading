...
2. Consider long opportunities when the price touches the upper band, and short opportunities when touching the lower band.
...
The advantage of this strategy is introducing stop loss and take profit rules to cut losses in time when the trend goes wrong, and to take profits before the wave ends. It also provides re-entry signals for sustained trend trading participation.
...
- Smoothed entry and exit prevent false breaks
...
| v_input_3_close| 0       | Source: close/high/low/open  |
...
```pinescript
// Backtest: start=2023-08-15 00:00:00, end=2023-08-23 00:00:00, period=2h, basePeriod=15m, exchanges=[{"eid":"Futures_Binance","currency":"BTC_USDT"}]
//@version=4
...
Last Modified: 2023-09-15 14:41:46
```