...
Backtest for one year, K-line period of 15 minutes.
Initial capital: 50,000 u, trade 50 Ether per open order, no take profit or stop loss (set to 10000%).
Adjust the number of orders opened, take profit and stop loss parameters, and other parameters as needed.
...
|v_input_28|50|Number of Orders to Open|
...
array.set(os, 0, a == b ? 1 : a == c ? 0 : os[1])
//----
upper = beta*b + (1-beta)*c
lower = beta*c + (1-beta)*b 
ts := os[0]*upper + (1-os[0])*lower
result := ts
...
Note: The original code snippet had some inconsistencies and missing parts. These have been corrected to provide a coherent structure while maintaining the logic as described in the strategy description. Please ensure you test the code thoroughly before using it for trading purposes. Additionally, make sure to validate all parameters according to your specific requirements.