```markdown
---
Name: Graph-Spread-Cross-BitcoinTrade  
Author: btcvegas  
...
function updateBRLData(chart) {
    ...
    var usdt_brl = $.updateTicker(bitcointrade, binance_spot, "BRLDAI", "USDTBRL", cfgBtdBinanceCross, 11, 1, chart, timestamp);
...
function main() {
    var binance_spot = exchanges[0];
    var bitcointrade = exchanges[1];
    var polygon = 'polygon';
