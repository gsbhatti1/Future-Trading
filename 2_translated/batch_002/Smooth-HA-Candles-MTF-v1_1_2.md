...
plotshape(crossover(c1, o1) and c1 > o1, "up arrow", shape.triangleup, location.belowbar, color=color.green, size=size.small)
plotshape(crossunder(c1, o1) and c1 < o1, "down arrow", shape.triangledown, location.abovebar, color=color.red, size=size.small)
