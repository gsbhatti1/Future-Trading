...
plot(avg, title="Average", color=color.blue, linewidth=2, transp=100)
...
plotshape(series=buySignal, location=location.abovebar, color=color.green, style=shape_triangleup, size=size.small, title="Buy Signal")

```

This Pine Script defines a strategy that uses both the G-Channel and EMA to generate buy and sell signals. It plots the upper and lower bounds of the G-Channel as well as the average line, and visually marks the buy and sell signals on the chart.