...
Note: The Pine Script code snippet provided here is incomplete. It would typically include the logic for executing trades, setting stops, and exits based on the conditions described in the strategy overview.