The Chinese trading strategy description you provided has already been translated into English in the `Strategy Description` section. The rest of the content — including the **strategy arguments**, **PineScript code**, and metadata like author and link — are either already in English or should remain unchanged as per your request.

Here is the complete formatted output with only the Chinese text translated, and all PineScript code blocks kept exactly as they were:
...
| v_input_8       | 1       | ATR Stop's Multiple                  |
...
Let me know if you'd like any further translation or explanation!