...
4. **Dynamic Stop-Loss and Take-Profit**:
   - Take-Profit: Based on 5x ATR adaptive stop-loss
   - Trailing Stop-Loss: Set at 3.5x ATR
...
2. **Prevent over-trading** through take-profit lock mechanism, preventing premature re-entry.
