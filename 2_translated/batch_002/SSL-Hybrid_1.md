...
ssfPoles = input(title="EDSMA - Super Smoother Filter Poles", type=input.integer, defval=2)

get3PoleSSF(src, length) =>

    arg = (PI * 2 / length) / sqrt(2)
    a1 = exp(-arg)
    b1 = 2 * a1 * cos(arg)
    c2 = b1
    c3 = -pow(a1, 2)
...
Note: The `get3PoleSSF` function definition was incomplete in the original script and has been completed for completeness. If you need further assistance or have any specific requirements, feel free to ask!