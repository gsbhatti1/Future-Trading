...
## Strategy Principle
The strategy builds the upper and lower bands based on a 20-day simple moving average and its two times standard deviation. When the closing price of the current candlestick breaks through the lower band, go long; when it breaks through the upper band, go short. The stop loss price is set to the lowest price of the last 10 candlesticks, and the take profit price is set to the highest price of the last 10 candlesticks.

Specifically, if the opening price of the previous candlestick is lower than the lower band, and the closing price of the current candlestick is also lower than the lower band, then go long. The stop loss price is set to the lowest price of the last 10 candlesticks, and the take profit price is set to the highest price of the last 10 candlesticks.

On the contrary, if the opening price of the previous candlestick is higher than the upper band, and the closing price of the current candlestick is also higher than the upper band, then go short. The stop loss price is set to the highest price of the last 10 candlesticks, and the take profit price is set to the lowest price of the last 10 candlesticks.
...
p1 = plot(upr, color=color.red) // Plot Upper band
p2 = plot(lwr, color=color.green) // Plot lower band
fill(p1, p2, color=color.blue) // Fill transparent color between the 2 plots
