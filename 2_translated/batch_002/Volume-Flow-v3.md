...
The DepthHouse Volume Flow indicator is used to help determine trend direction strictly based on Negative and Positive volume data.

How to Read:
- Moving Average crossovers are used to help determine a possible trend change or retracement.
- The area cloud at the bottom is calculated by the difference between the moving averages. This can be used to help determine the strength of trending volume.
- Brightly colored volume bars represent large volume spikes calculated using the x factor set in the options.

Other changes:
- DepthHouse is making numerous indicators open-source, and this is just one among many!
- Volume is now displayed without modification for calculation purposes.
