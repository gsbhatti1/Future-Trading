...
The code block provided at the end is the Pine Script for backtesting and implementing the MACD Trend Prediction Strategy. It has been kept as is, with the final lines ensuring that buy and sell signals are generated based on the comparison between `LigneMACDZeroLag` and `Lignesignal`.