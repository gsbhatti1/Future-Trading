...
For those who are using charts with a white background, they should change the indicator options->style from black to white.
OB/OS zones are at 200 and -200 and marked with an aqua color above and below the candles.
...
UPshape = if up > ob and up > down then ta.highest(up, 1) + 20 else if up > ob and up < down then ta.highest(down, 1) + 20 else na
DOWNshape = if down < os and up > down then ta.lowest(down, 1) - 20 else if down < os and up < down then ta.lowest(up, 1) - 20 else na
