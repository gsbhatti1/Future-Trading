...
For those using charts with a white background, they should change the indicator options->style to use white color instead of black. OB/OS zones are set at 200 and -200 and marked with an aqua color above and below the candles.
