    ...
    while (true) {
        ...
        if (position.length == 0) {
            ...
            if (randomNum > 0.5) {
                ...
                exchange.Sell(-1, unit, "Open short position");
            }
            if (randomNum < 0.5) {
                exchange.SetDirection("buy");
                exchange.Buy(-1, unit, "Open long position");
            }
        }
        if (position.length > 0) {
            ...
            if (type == 0) {
                if (profit > profits) {
                    ...
                    exchange.Sell(-1, amount, "Close long position for profit taking. Current profit: " + profit);
                    unit = 0.015;
                }
            ...
            if (type == 1) {
                if (profit > profits) {
                    ...
                    // Close short position for profit taking. Current profit: profit
                }
            }
        }
    }
