...
3. If the closing price is higher than the closing price 65 bars ago, it indicates a price breakout and generates a long signal
4. If the closing price is lower than the closing price 65 bars ago, it indicates a price breakout and generates a short signal
...
- Use ADX to determine trends, avoiding missing trend opportunities
...
- Kevin Davey's multi-year live trading verification, not curve fitting
...
Overall, this is a very practical crude oil trading strategy. It uses the ADX indicator to determine trends reasonably. The price breakout principle is simple and effective with good backtest results. At the same time, as Kevin Davey's public free strategy, it has strong reliability in actual combat. Although there is still room for improvement in the strategy, it is a very suitable choice for beginners and small capital traders to get started and practice.
