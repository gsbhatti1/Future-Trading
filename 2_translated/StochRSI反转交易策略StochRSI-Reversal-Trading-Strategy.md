...
// Plot signals
plotshape(series=bullCond, title="L", location=location.belowbar, color=color.green, style=shape.labelup, text="Buy")
```

This completes the translation and keeps the code block and formatting as in the original document.