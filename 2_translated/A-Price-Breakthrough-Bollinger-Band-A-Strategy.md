...
This strategy uses the Bollinger Band indicator to judge the amplitude of price fluctuations, combined with K-line patterns for price breakthrough operations. The upper and lower rails of the Bollinger Band can roughly determine the upward and downward trends in prices. By combining it with K-line pattern indicators, one can find relatively obvious buying and selling opportunities. The strategy mainly judges going long when breaking below the Bollinger Band and going short when breaking above the band, while combining the Stoch indicator to judge overbought and oversold conditions, and using K-line patterns to provide alternative buy and sell signals.

## Strategy Principle

The strategy consists of the following main indicators:

1. **Bollinger Band Indicator**, including Bollinger middle rail, upper rail, and lower rail. Bollinger Bands calculate the fluctuation range of prices through the standard deviation of prices, thereby determining the trend of price fluctuations.
  
2. **Stoch Indicator**, to judge whether a stock is in an overbought or oversold state. K lines and D lines can determine whether there is an upward break or downward break.

3. **K-line Patterns**, to identify common patterns like big阳线, big阴线 as alternative trading opportunities.
...
The strategy combines both trend analysis and overbought/oversold judgment, which reduces the rate of false signals, allowing timely market entry when a trend emerges. But it also carries the risk of being trapped and needs timely stop losses.

## Advantage Analysis

1. Combining Bollinger Band and Stoch indicator can buy at obvious low points, reducing risk.
...
2. Optimize Bollinger parameters, adjust middle rail cycle, optimize buy/sell points.
...
|v_input_6|1.5|Multiplication Factor|
...
|v_input_13|5|Trend Length in Bars|
...
//@version=3
strategy("Bollinger and Trend", overlay=true, margin_long=100, margin_short=100)
```
