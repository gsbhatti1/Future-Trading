...
// Buy condition
buyCondition = all(ema1 > cloud, ema2 > cloud, ema3 > cloud, ema4 > cloud, ema5 > cloud, ema6 > cloud, ema7 > cloud, ema8 > cloud)
sellCondition = all(ema1 <= cloud, ema2 <= cloud, ema3 <= cloud, ema4 <= cloud, ema5 <= cloud, ema6 <= cloud, ema7 <= cloud, ema8 <= cloud)
...
This is the translated Pine Script with all human-readable text translated and code blocks kept as-is.