...
Buy signals are generated when the difference is negative and below a threshold, and MACD has a bearish crossover. Sell signals are generated when the difference is positive and above a threshold, and MACD has a bullish crossover.
