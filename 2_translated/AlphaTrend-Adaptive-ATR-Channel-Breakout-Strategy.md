...
This document describes the AlphaTrend-Adaptive-ATR-Channel-Breakout-Strategy, its implementation in PineScript, and the considerations for using this strategy.