...
- The Ichimoku Kinko Hyo combines multiple factors to determine trends.
- Dynamic stops are used to lock in profits to the greatest extent.
- The rules are simple, clear, and easy to implement.

## Strategy Risk

- The Ichimoku Kinko Hyo can be slow and may miss opportunities.
- Careful optimization of parameter periods is needed.
- Only going long means you may miss good short selling opportunities.
...
2. Consider going long when close is above cloud and cloud is rising, with conversion above baseline.
3. Additionally, the lagging span must be above the clouds and price for uptrend confirmation.
4. When all criteria are met, go long.
5. If the lagging span falls below price or cloud, close long.

The strategy utilizes Ichimoku's indicators to confirm trend, with the cloud as dynamic stops for risk control.

## Advantages

- The Ichimoku Kinko Hyo synthesizes multiple factors for trend determination.
...
- The Ichimoku Kinko Hyo can be slow and may miss opportunities.
- Careful optimization of lookback periods is needed.
- Only going long, so good short selling chances are missed.

## Summary

This strategy leverages the synthesis of indicators from Ichimoku to define trend direction. With optimized parameters, it provides a simple long-only system. However, limitations in lag and being LONG-only require caution.
