...
strategy.exit("Close Long Position", "Long", stop=ycloud_stoploss, limit=ycloud_takeprofit)
```

This Pine Script defines the Cloud Nebula Dual Moving Average Breakthrough Strategy. It includes setting up the fast and slow moving averages to form dual clouds and defining the entry, stop loss, and take profit conditions for long trades based on these cloud structures.