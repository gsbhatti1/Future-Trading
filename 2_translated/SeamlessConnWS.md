...
function WSConnecter_Huobi (method, symbol) {
    ...
    */
    ...
    if (method == "GetTicker") {
        ...
        throw "Not implemented: " + method + " method!"
    }
    
    var self = {}
    self.method = method
    self.pingCount = 0
    Log("Dial function URL:", "wss://api.huobi.pro/ws|compress=gzip&mode=recv&reconnect=true&payload=" + strSubscribe)
...
function WSConnecter_Binance (method, symbol) {
    ...
    self.pingCount = 0
    self.method = method
    Log("Dial function URL:", "wss://stream.binance.com:9443" + strSubscribe + "|reconnect=true")
        ...
        try {
            ...
            if (objRet.ping) {
                ...
                */
                ...
                Log("Ticker pushed:", ticker)   // Test log
