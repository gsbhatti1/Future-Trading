...
The weights are configurable in settings, and as an example, 50 length has been used.
...
The indicator provides a good resistance and support value on the larger time frame. It also provides breakout and breakdown indications. Follow through is mostly effective.
