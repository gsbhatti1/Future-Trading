...
Add an EMA line to determine the trend direction. Allow buying only when the price is above the EMA line (an uptrend). This filter can be enabled or disabled.
...
EndTime = input(defval=timestamp('01 Jan 2099 0