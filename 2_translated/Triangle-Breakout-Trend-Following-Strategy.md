...
Triangle Breakout Trend Following Strategy Triangle-Breakout-Trend-Following-Strategy
...
1. Use fast EMA and medium EMA to determine trend direction. Fast EMA crossing above medium EMA is a long signal.

2. Use the highest and lowest prices of the last N bars to determine if an ascending triangle is formed. Triangle formation gives a long signal.

3. After entry, when fast EMA crosses below medium EMA, it indicates trend reversal and gives an exit signal.

4. Set stop loss at a certain percentage below the entry price for stop loss exit.

5. Set take profit target at a certain percentage above the entry price for partial profit taking.
...
2. Stop loss too close tends to get stopped out prematurely, while too far fails to control loss. Evaluate and optimize parameter.
