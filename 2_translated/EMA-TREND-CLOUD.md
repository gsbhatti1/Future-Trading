...
Plots the 9 and 20 period exponential moving averages (EMA) and paints a cloud between them, visually identifying the intraday trend and its strength. A green cloud indicates a long position, while a red cloud indicates a short position. The thicker the cloud, the stronger the trend. Long entry occurs when the 9 EMA crosses above the 20 EMA, causing the cloud to turn green; opposite for short.

Aggressive entry is at the close of the bar that causes the cross to happen. Conservative entry is when the second bar after the cross closes above the 9 EMA and is in the direction of the trade.

Exits can occur when price closes within the cloud, on the opposite side of the cloud, or when the averages cross in the opposite direction of the trade depending on individual risk tolerance.
