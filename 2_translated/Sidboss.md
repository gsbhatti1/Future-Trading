...
Name: Sidboss
Author: ChaoZhang
Strategy Description: Use for buy and sell signals. Use settings 100,3.
...
barcolor = src > filt and src > src[1] and upward > 0 ? color.lime : 
            ...
            src < filt and src > src[1] and downward > 0 ? color.maroon : 
            color.orange
...
> Detail: https://www.fmz.com/strategy/363562

> Last Modified: 2022-05-17 10:23:58
```