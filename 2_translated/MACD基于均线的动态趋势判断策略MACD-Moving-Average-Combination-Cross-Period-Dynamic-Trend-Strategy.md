...
MACD Based Moving Average Combination Cross Period Dynamic Trend Strategy (MACD-Moving-Average-Combination-Cross-Period-Dynamic-Trend-Strategy)
...
2. The MACD difference crossing above the signal line is a long signal; crossing below is a short signal.
