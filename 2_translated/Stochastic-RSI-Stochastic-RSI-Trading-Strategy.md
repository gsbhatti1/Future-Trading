...
This strategy is based on the Stochastic RSI indicator. The Stochastic RSI indicator is an oscillator produced by combining the stochastic indicator and the relative strength index (RSI). This strategy uses the crossing of the long-short line in the Stochastic RSI to determine and generate trading signals.

## Strategy Principle

1. Calculate the 14-period RSI of close, which is rsi1.
2. Calculate Stochastic K and D values based on rsi1.
...
1. Stochastic RSI combines the strengths of RSI and Stochastic oscillators and is a good oscillator.
2. Combined with the judgment of overbought and oversold areas, false breakouts can be filtered out.
