...
longCondition = ta.crossover(macdLine, signalLine) // Buy on crossover of MACD above the signal line
shortCondition = ta.crossunder(macdLine, signalLine) // Sell on crossover of MACD below the signal line
...
trailStopPrice = math.max(longStopLevel, na)
strategy.exit("Trailing Stop", from_entry="Long Entry", limit=longTakeProfitLevel, stop=trailStopPrice)
```

This completes the translation and preservation of your trading strategy document.