...
set two pane TradingView chart, set first pane to 15Min and second to 1min.
...
On the 15min chart draw any obvious Vertical Trend Lines (VT), use Pivots points as a guide.
