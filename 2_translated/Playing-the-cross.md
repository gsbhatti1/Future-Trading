...
Kijun-sen is the base line of the Ichimoku Cloud or the midpoint price of the last 26 periods.
Moving Average is a constantly updated average price of a given range.
In this script, I used the standard Kijun-sen settings and the Moving Average with a length of 55.
