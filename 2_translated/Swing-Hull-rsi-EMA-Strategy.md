...
A swing trading strategy that uses a combination of indicators. The Hull average is used to determine the trend direction, while EMA and RSI handle the rest. Use it at your own risk, especially at the end of any Hull trend.
...
strategy.close("SYS-SHORT", when=closeShort) // exit logic

if not na(vrsi)
    if longCondition // swing condition          
        if price[0] < mafast[0] and price[1] > mafast[1] // cross entry
            strategy.entry("SYS-LONG", strategy.long, comment="long")
strategy.close("SYS-LONG", when=closeLong) // exit logic
...
[https://www.fmz.com/strategy/365668](https://www.fmz.com/strategy/365668)
